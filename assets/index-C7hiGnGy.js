import{M as ka,b as ya,T as wa}from"./bootstrap-CeGnflBh.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=t(n);fetch(n.href,s)}})();const Aa={"/":"view-landing","/home":"view-landing","/form":"view-form","/preview":"view-preview","/result":"view-result","/draft":"view-draft","/history":"view-history","/doa":"view-doa","/settings":"view-settings"};function aa(){return window.location.hash.slice(1)||"/"}function Sa(a){document.querySelectorAll(".view-section").forEach(i=>{i.classList.add("d-none")});const t=document.getElementById(a);if(t){t.classList.remove("d-none"),window.scrollTo(0,0);const i=new CustomEvent("viewChanged",{detail:{viewId:a,path:aa()}});window.dispatchEvent(i)}else console.error(`View with ID "${a}" not found`)}function Ta(a){document.querySelectorAll(".navbar-nav .nav-link").forEach(t=>{const i=t.getAttribute("href");t.classList.remove("active"),(i===`#${a}`||a==="/"&&i==="#/")&&t.classList.add("active")})}function F(){const a=aa(),e=Aa[a];e?(Sa(e),Ta(a)):(console.warn(`Route "${a}" not found, redirecting to home`),v("/"))}function v(a){window.location.hash=`#${a}`}function Ea(){F(),window.addEventListener("hashchange",F),document.addEventListener("click",a=>{const e=a.target.closest('a[href^="#/"]');if(e){a.preventDefault();const t=e.getAttribute("href").slice(1);v(t)}})}let E=null,D=null,P=null;function Da(){return q(),E=a=>{a.key==="Escape"&&Pa()},D=a=>{La(a.target)},P=()=>{Ia()},document.addEventListener("keydown",E),document.addEventListener("show.bs.modal",D),document.addEventListener("hide.bs.modal",P),q}function q(){E&&(document.removeEventListener("keydown",E),E=null),D&&(document.removeEventListener("show.bs.modal",D),D=null),P&&(document.removeEventListener("hide.bs.modal",P),P=null)}function Pa(){const a=document.querySelector(".modal.show");if(a){const e=ka.getInstance(a);e&&e.hide()}}const H=new WeakMap;function La(a){if(!a)return;if(H.has(a)){const s=H.get(a);a.removeEventListener("keydown",s)}const e=a.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),t=e[0],i=e[e.length-1];a.dataset.previousFocus=document.activeElement?.id||"",setTimeout(()=>{if(t)try{t.focus()}catch{}},100);const n=s=>{if(s.key==="Tab"){if(s.shiftKey){if(document.activeElement===t){s.preventDefault();try{i.focus()}catch{}}}else if(document.activeElement===i){s.preventDefault();try{t.focus()}catch{}}}};H.set(a,n),a.addEventListener("keydown",n)}function Ia(){const a=document.querySelector(".modal");if(a&&a.dataset.previousFocus){const e=document.getElementById(a.dataset.previousFocus);if(e){const t=e.hasAttribute("disabled"),i=e.offsetParent===null;if(!t&&!i)try{e.focus()}catch{}}}}function Ca(){document.addEventListener("keydown",a=>{if((a.ctrlKey||a.metaKey)&&a.key==="s"){a.preventDefault();const e=document.getElementById("btn-save-draft");e&&!e.disabled&&e.click()}if((a.ctrlKey||a.metaKey)&&a.key==="Enter"){const e=document.querySelector('button[type="submit"]');e&&!e.disabled&&e.click()}})}function ja(){const a=document.getElementById("view-landing");a.innerHTML=`
    <!-- Hero Section -->
  ...
  `,xa()}function xa(){const a=document.getElementById("btn-start");a&&a.addEventListener("click",()=>{v("/form")}),document.querySelectorAll(".btn-feature").forEach(t=>{t.addEventListener("click",i=>{const n=i.currentTarget.getAttribute("data-route");n&&v(n)})})}function $(){ja()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-landing"&&$()});(window.location.hash===""||window.location.hash==="#/"||window.location.hash==="#/home")&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$):$());const f={REQUIRED:"Kolom ini wajib diisi.",MIN_LENGTH:a=>`Minimal ${a} karakter.`,MAX_LENGTH:a=>`Maksimal ${a} karakter.`,EMAIL:"Format email tidak valid.",NUMBER:"Harus berupa angka.",MIN_VALUE:a=>`Nilai minimal adalah ${a}.`,MAX_VALUE:a=>`Nilai maksimal adalah ${a}.`,DATE_FUTURE:"Tanggal tidak boleh di masa depan.",PHONE:"Format nomor telepon tidak valid (10-15 digit).",CONDITIONAL:"Kolom ini wajib diisi berdasarkan pilihan sebelumnya.",PATTERN:"Format input tidak sesuai."},Ma={namaLengkap:{required:!0,minLength:3},tempatLahir:{required:!0},tanggalLahir:{required:!0,maxDate:"today"},jenisKelamin:{required:!0},tinggiBadan:{required:!0,min:100,max:250},beratBadan:{required:!0,min:30,max:200},pekerjaan:{required:!0},statusPernikahan:{required:!0},jumlahAnak:{conditional:!0,min:0,max:20},domisili:{required:!0},statusIzin:{required:!0},pendidikanTerakhir:{required:!0,minLength:10},infoAyah:{required:!0,minLength:10},infoIbu:{required:!0,minLength:10},urutanAnak:{required:!0,pattern:/^\d+\s+dari\s+\d+$/},shalatWajib:{required:!0},bacaanQuran:{required:!0},sifatPositif:{required:!0},sifatNegatif:{required:!0},merokok:{required:!0},statusHijab:{conditional:!0},statusJenggot:{conditional:!0},visiPernikahan:{required:!0,minLength:20},kriteriaPasangan:{required:!0,minLength:20},kesediaanPoligami:{conditional:!0},kesediaanDipoligami:{conditional:!0},noHP:{pattern:/^[0-9]{10,15}$/},email:{type:"email"}},Ka=a=>{const e=a.querySelectorAll("input, select, textarea");return Array.from(e).filter(t=>!t.closest(".d-none"))},ea=a=>a.nextElementSibling?.classList.contains("invalid-feedback")?a.nextElementSibling:null,Ba=(a,e)=>a.hasAttribute("required")&&!e?(y(a,f.REQUIRED),!1):!0,Ha=(a,e,t)=>t?.minLength&&e.length<t.minLength?(y(a,f.MIN_LENGTH(t.minLength)),!1):t?.maxLength&&e.length>t.maxLength?(y(a,f.MAX_LENGTH(t.maxLength)),!1):!0,$a=(a,e,t)=>{if(a.type!=="number")return!0;const i=parseFloat(e);return t?.min!==void 0&&i<t.min?(y(a,f.MIN_VALUE(t.min)),!1):t?.max!==void 0&&i>t.max?(y(a,f.MAX_VALUE(t.max)),!1):!0},Na=(a,e,t)=>{if(a.type!=="date"||t?.maxDate!=="today")return!0;const i=new Date(e),n=new Date;return n.setHours(0,0,0,0),i>n?(y(a,f.DATE_FUTURE),!1):!0},Ra=(a,e,t,i)=>{if(!t?.pattern||!e)return!0;if(!t.pattern.test(e)){const n=i==="noHP"?f.PHONE:f.PATTERN;return y(a,n),!1}return!0},Va=(a,e,t)=>t?.type!=="email"||!e||/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)?!0:(y(a,f.EMAIL),!1),J=(a,e=!1)=>{try{const t=a.hasAttribute("required"),i=a.value.trim()!=="";if(e&&!(a.classList.contains("is-invalid")||a.classList.contains("is-valid")))return;if(L(a),!t&&!i){L(a);return}if(a.checkValidity())ia(a);else{const s=ea(a)?.textContent||f.REQUIRED;y(a,s)}}catch(t){console.error("[ValidationService] Error in validateFieldOnEvent:",t)}};function ta(a){try{if(!a)return console.error("[ValidationService] Field is null or undefined"),!1;const e=a.name||a.id,t=a.value.trim(),i=Ma[e];return L(a),a.closest(".d-none")?!0:Ba(a,t)?!t&&!a.hasAttribute("required")?!0:!Ha(a,t,i)||!$a(a,t,i)||!Na(a,t,i)||!Ra(a,t,i,e)||!Va(a,t,i)?!1:a.checkValidity()?(ia(a),!0):(y(a,a.validationMessage||f.REQUIRED),!1):!1}catch(e){return console.error("[ValidationService] Error in validateField:",e),!1}}function _a(a){try{if(!a)return console.error("[ValidationService] Form element is null or undefined"),{isValid:!1,firstInvalidField:null};const t=Ka(a).filter(i=>!ta(i));return{isValid:t.length===0,firstInvalidField:t[0]||null}}catch(e){return console.error("[ValidationService] Error in validateForm:",e),{isValid:!1,firstInvalidField:null}}}function y(a,e){a.classList.remove("is-valid"),a.classList.add("is-invalid");const t=ea(a);t&&(t.textContent=e)}function ia(a){a.classList.remove("is-invalid"),a.classList.add("is-valid")}function L(a){a.classList.remove("is-invalid","is-valid")}function Oa(a){try{if(!a){console.error("[ValidationService] Form element is null or undefined");return}a.querySelectorAll("input, select, textarea").forEach(t=>{t.addEventListener("blur",()=>{J(t,!1)}),t.addEventListener("input",()=>{J(t,!0)})})}catch(e){console.error("[ValidationService] Error initializing real-time validation:",e)}}const Fa=36,qa=2,Ja=6;function Wa(){if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID();if(typeof crypto<"u"&&crypto.getRandomValues){const a=new Uint8Array(16);crypto.getRandomValues(a),a[6]=a[6]&15|64,a[8]=a[8]&63|128;const e=Array.from(a,t=>t.toString(16).padStart(2,"0")).join("");return`${e.slice(0,8)}-${e.slice(8,12)}-${e.slice(12,16)}-${e.slice(16,20)}-${e.slice(20)}`}throw new Error("Crypto API not available. Cannot generate secure UUID.")}function Ua(a="id"){const e=Date.now(),t=Math.random().toString(Fa).substring(qa,Ja);return`${a}_${e}_${t}`}function Ga(){return Ua("draft")}function Ya(){return`cv_${Wa()}`}function M(){return new Date().toISOString()}function za(a){if(!a)return null;const e=new Date(a);if(isNaN(e.getTime()))return null;const t=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agt","Sep","Okt","Nov","Des"],i=String(e.getDate()).padStart(2,"0"),n=t[e.getMonth()],s=e.getFullYear();return`${i} ${n} ${s}`}function N(a){if(!a)return null;const e=new Date(a);if(isNaN(e.getTime()))return null;const t=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agt","Sep","Okt","Nov","Des"],i=String(e.getDate()).padStart(2,"0"),n=t[e.getMonth()],s=e.getFullYear(),o=String(e.getHours()).padStart(2,"0"),l=String(e.getMinutes()).padStart(2,"0");return`${i} ${n} ${s}, ${o}:${l}`}function na(a,e=!1){return e?N(a):za(a)}const k={DRAFTS:"taaruf_cv_drafts",HISTORY:"taaruf_cv_history",SETTINGS:"taaruf_cv_settings"};M();function R(){try{const a="__storage_test__";return localStorage.setItem(a,a),localStorage.removeItem(a),!0}catch(a){return console.error("localStorage is not available:",a),!1}}function I(a,e){try{if(!R())return{success:!1,message:"localStorage tidak tersedia. Pastikan browser Anda tidak dalam mode privat.",error:new Error("Storage not available")};const t=JSON.stringify(e);return localStorage.setItem(a,t),{success:!0,message:"Data berhasil disimpan"}}catch(t){return t.name==="QuotaExceededError"?{success:!1,message:"Penyimpanan penuh. Hapus draft/history lama untuk melanjutkan.",error:t}:{success:!1,message:`Gagal menyimpan data: ${t.message}`,error:t}}}function K(a){try{if(!R())return{success:!1,data:null,message:"localStorage tidak tersedia",error:new Error("Storage not available")};const e=localStorage.getItem(a);return e===null?{success:!0,data:null,message:"Data tidak ditemukan"}:{success:!0,data:JSON.parse(e),message:"Data berhasil dimuat"}}catch(e){return console.error(`Error loading data from ${a}:`,e),{success:!1,data:null,message:"Data corrupt atau format tidak valid. Pertimbangkan untuk reset data.",error:e}}}const Qa=(a,e=null)=>{const t=Ga(),i=M(),n=e||`Draft - ${a.namaLengkap||"Tanpa Nama"} - ${na(i)}`;return{id:t,name:n,createdAt:i,lastUpdated:i,data:a}},Xa=(a,e,t,i)=>{const n=M();return a.map(s=>s.id===e?{...s,lastUpdated:n,data:t,...i&&{name:i}}:s)};function Za(a,e=null,t=null){try{const n=K(k.DRAFTS).data||[];if(t){if(!n.some(m=>m.id===t))return{success:!1,message:"Draft tidak ditemukan"};const o=Xa(n,t,a,e),l=I(k.DRAFTS,o);return l.success?{...l,data:{id:t}}:l}else{const s=Qa(a,e),o=[...n,s],l=I(k.DRAFTS,o);return l.success?{...l,data:{id:s.id}}:l}}catch(i){return{success:!1,message:`Error saving draft: ${i.message}`,error:i}}}function V(){const a=K(k.DRAFTS);return a.success?a.data||[]:(console.error("Error loading drafts:",a.message),[])}function sa(a){return V().find(t=>t.id===a)||null}function ae(a){try{const e=V();if(!e.some(n=>n.id===a))return{success:!1,message:"Draft tidak ditemukan"};const i=e.filter(n=>n.id!==a);return I(k.DRAFTS,i)}catch(e){return{success:!1,message:`Error deleting draft: ${e.message}`,error:e}}}function ee(a,e,t=null){try{const n=K(k.HISTORY).data||[],s=Ya(),o=M(),l=t||`${a.namaLengkap} - ${na(o)}`,m={id:s,name:l,generatedAt:o,cvTextContent:e,sourceData:a},u=[...n,m],g=I(k.HISTORY,u);return g.success?{...g,data:{id:s}}:g}catch(i){return{success:!1,message:`Error saving history: ${i.message}`,error:i}}}function _(){const a=K(k.HISTORY);return a.success?a.data||[]:(console.error("Error loading history:",a.message),[])}function O(a){return _().find(t=>t.id===a)||null}function te(a){try{const e=_();if(!e.some(n=>n.id===a))return{success:!1,message:"History tidak ditemukan"};const i=e.filter(n=>n.id!==a);return I(k.HISTORY,i)}catch(e){return{success:!1,message:`Error deleting history: ${e.message}`,error:e}}}function ie(){try{return R()?(Object.values(k).forEach(a=>{localStorage.removeItem(a)}),{success:!0,message:"Semua data berhasil dihapus"}):{success:!1,message:"localStorage tidak tersedia"}}catch(a){return{success:!1,message:`Error clearing data: ${a.message}`,error:a}}}const ne="toast-container",se="toast",re="toast",oe="toast-header",le="toast-body",de=2,ce=9,W="Notifikasi",U="info",G=5e3,Y={success:{icon:"bi bi-check-circle-fill text-success",headerClass:"bg-success bg-opacity-10"},error:{icon:"bi bi-exclamation-circle-fill text-danger",headerClass:"bg-danger bg-opacity-10"},warning:{icon:"bi bi-exclamation-triangle-fill text-warning",headerClass:"bg-warning bg-opacity-10"},info:{icon:"bi bi-info-circle-fill text-primary",headerClass:"bg-primary bg-opacity-10"},loading:{icon:"spinner-border spinner-border-sm text-white",headerClass:"bg-danger text-white"}},d=(a,e)=>{let t;if(typeof a=="string")t={title:W,message:a,type:e||U,duration:G};else if(typeof a=="object"&&a!==null)t={title:a.title||W,message:a.message||"",type:a.type||U,duration:a.duration!==void 0?a.duration:G,onClose:a.onClose};else{console.error("[ToastNotification] Invalid options parameter");return}const{title:i,message:n,type:s,duration:o,onClose:l}=t,m=`${se}-${Date.now()}-${Math.random().toString(36).substr(de,ce)}`,u=document.getElementById(ne);if(!u){console.error("[ToastNotification] Toast container not found");return}const g=ue(s),w=`
  ...
  `;u.insertAdjacentHTML("beforeend",w);const p=document.getElementById(m);if(!p){console.error("[ToastNotification] Failed to create toast element");return}const B=new bootstrap.Toast(p,{autohide:o>0,delay:o});p.addEventListener("hidden.bs.toast",()=>{p.remove(),typeof l=="function"&&l()}),B.show()},ue=a=>Y[a]||Y.info,me="spinner-border-sm",j="originalContent",x="originalDisabled";function C(a,e="Memproses..."){a&&(a.dataset[j]=a.innerHTML,a.dataset[x]=a.disabled,a.disabled=!0,a.innerHTML=`
    <span class="spinner-border ${me} me-2" role="status" aria-hidden="true"></span>
    ${e}
  `)}function S(a){a&&(a.dataset[j]&&(a.innerHTML=a.dataset[j],delete a.dataset[j]),a.dataset[x]!==void 0?(a.disabled=a.dataset[x]==="true",delete a.dataset[x]):a.disabled=!1)}const h={TEMP_DATA:"taaruf_cv_temp_data",DRAFT_TO_LOAD:"taaruf_cv_draft_to_load",GENERATED_TEXT:"taaruf_cv_generated_text",SOURCE_DATA:"taaruf_cv_source_data"};function be(){const a=document.getElementById("view-form");a.innerHTML=`
    <!-- Form Header -->
    <div class="mb-4">
      <h2>
  ...
  `;const e=new Date().toISOString().split("T")[0],t=document.getElementById("tanggalLahir");t&&t.setAttribute("max",e),ge()}function ge(){const a=document.getElementById("cv-form"),e=document.getElementById("btn-reset-form"),t=document.getElementById("btn-save-draft"),i=document.getElementById("jenisKelamin"),n=document.getElementById("statusPernikahan");i&&i.addEventListener("change",ra),n&&n.addEventListener("change",oa),pe(a),a&&a.addEventListener("submit",s=>{s.preventDefault(),ve()}),e&&e.addEventListener("click",()=>{fe()}),t&&t.addEventListener("click",()=>{he()})}function ra(a){const e=a.target.value,t=document.getElementById("wrapper-statusJenggot"),i=document.getElementById("wrapper-kesediaanPoligami"),n=document.getElementById("statusJenggot"),s=document.getElementById("kesediaanPoligami"),o=document.getElementById("wrapper-statusHijab"),l=document.getElementById("wrapper-kesediaanDipoligami"),m=document.getElementById("statusHijab"),u=document.getElementById("kesediaanDipoligami");e==="Laki-laki"?(t.classList.remove("d-none"),i.classList.remove("d-none"),n.setAttribute("required","required"),s.setAttribute("required","required"),o.classList.add("d-none"),l.classList.add("d-none"),m.removeAttribute("required"),u.removeAttribute("required"),m.value="",u.value=""):e==="Perempuan"?(o.classList.remove("d-none"),l.classList.remove("d-none"),m.setAttribute("required","required"),u.setAttribute("required","required"),t.classList.add("d-none"),i.classList.add("d-none"),n.removeAttribute("required"),s.removeAttribute("required"),n.value="",s.value=""):(t.classList.add("d-none"),i.classList.add("d-none"),o.classList.add("d-none"),l.classList.add("d-none"),n.removeAttribute("required"),s.removeAttribute("required"),m.removeAttribute("required"),u.removeAttribute("required"))}function oa(a){const e=a.target.value,t=document.getElementById("wrapper-jumlahAnak"),i=document.getElementById("jumlahAnak");e==="Duda"||e==="Janda"?(t.classList.remove("d-none"),i.setAttribute("required","required")):(t.classList.add("d-none"),i.removeAttribute("required"),i.value="")}function pe(a){a.querySelectorAll("input, select, textarea").forEach(t=>{t.addEventListener("blur",()=>{ta(t)}),t.addEventListener("input",()=>{t.classList.contains("is-invalid")&&L(t)})})}function la(){const a=document.getElementById("cv-form"),e={};return a.querySelectorAll("input, select, textarea").forEach(i=>{const n=i.name||i.id,s=i.value.trim();i.closest(".d-none")||!n||(e[n]=s)}),e}function he(){const a=document.getElementById("btn-save-draft"),e=la();if(!Object.values(e).some(i=>i!=="")){d("Tidak ada data untuk disimpan","warning");return}C(a,"Menyimpan..."),setTimeout(()=>{const i=Za(e);S(a),i.success?d("Draft berhasil disimpan! Anda dapat melanjutkan nanti.","success"):(d(i.message||"Gagal menyimpan draft","error"),console.error("[FormView] Save draft failed:",i))},500)}function z(a){const e=document.getElementById("cv-form");!e||!a||(Object.keys(a).forEach(t=>{const i=e.querySelector(`[name="${t}"], #${t}`);i&&a[t]&&(i.value=a[t],(t==="jenisKelamin"||t==="statusPernikahan")&&i.dispatchEvent(new Event("change")))}),d("Draft berhasil dimuat","success"))}function ve(){const a=document.getElementById("cv-form"),e=_a(a);if(!e.isValid){d("Form belum lengkap. Periksa field yang ditandai merah.","error"),e.firstInvalidField&&(e.firstInvalidField.scrollIntoView({behavior:"smooth",block:"center"}),e.firstInvalidField.focus());return}const t=la();try{sessionStorage.setItem(h.TEMP_DATA,JSON.stringify(t)),v("/preview")}catch(i){console.error("[FormView] Error saving to sessionStorage:",i),d("Gagal menyimpan data. Silakan coba lagi.","error")}}function fe(){if(confirm("Apakah Anda yakin ingin mereset semua isian form?")){const a=document.getElementById("cv-form");a.reset(),ra({target:{value:""}}),oa({target:{value:"Lajang"}}),a.querySelectorAll("input, select, textarea").forEach(t=>L(t)),d("Form berhasil direset","info")}}function ke(){be();const a=document.getElementById("cv-form");a&&Oa(a);const e=sessionStorage.getItem(h.DRAFT_TO_LOAD);if(e)try{const i=JSON.parse(e);setTimeout(()=>{z(i),sessionStorage.removeItem(h.DRAFT_TO_LOAD)},100);return}catch(i){console.error("[FormView] Error loading draft:",i),d("Gagal memuat draft","error")}const t=sessionStorage.getItem(h.TEMP_DATA);if(t)try{const i=JSON.parse(t);setTimeout(()=>{z(i),sessionStorage.removeItem(h.TEMP_DATA)},100);return}catch(i){console.error("[FormView] Error loading temp data:",i),d("Gagal memuat data dari preview","error")}}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-form"&&ke()});const da=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],ye=a=>{if(!a||a==="")return"-";try{const e=a.split("-");if(e.length!==3)return"-";const[t,i,n]=e,s=parseInt(t,10),o=parseInt(i,10),l=parseInt(n,10);return isNaN(s)||isNaN(o)||isNaN(l)||o<1||o>12||l<1||l>31?"-":`${l} ${da[o-1]} ${s}`}catch(e){return console.error("[cvGeneratorService] Error formatting date:",e),"-"}},r=a=>a==null||a===""?"-":String(a).trim(),we=()=>{const a=new Date,e=a.getDate(),t=da[a.getMonth()],i=a.getFullYear();return`${e} ${t} ${i}`},A=a=>`${a}
${"-".repeat(64)}
`,c=(a,e)=>`${a.padEnd(20)}: ${e}
`,b=(a,e)=>`${a}:
${e}
...
`)},Se=(a,e)=>{const t=[A("I. DATA PRIBADI"),c("Nama Lengkap",r(a.namaLengkap)),c("Nama Panggilan",r(a.namaPanggilan)),c("Tempat, Tgl Lahir",`${r(a.tempatLahir)}, ${e}`),c("Jenis Kelamin",r(a.jenisKelamin)),c("Tinggi / Berat",`${r(a.tinggiBadan)} cm / ${r(a.beratBadan)} kg`),c("Warna Kulit",r(a.warnaKulit)),c("Suku Bangsa",r(a.suku)),c("Domisili Saat Ini",r(a.domisili)),c("Asal Daerah",r(a.asalDaerah)),c("Pekerjaan",r(a.pekerjaan)),c("Pengalaman Kerja",r(a.pengalamanKerja)),c("Penghasilan Bulanan",r(a.penghasilanBulanan)),c("Status Tempat Tinggal",r(a.statusRumah)),c("Status Pernikahan",r(a.statusPernikahan))];return(a.statusPernikahan==="Duda"||a.statusPernikahan==="Janda")&&t.push(c("Jumlah Anak",r(a.jumlahAnak))),t.push(c("Pernah Khitbah",r(a.pernahKhitbah)),c("Status Izin Wali",r(a.statusIzin)),`
`),t.join("")},Te=a=>[A("II. RIWAYAT PENDIDIKAN"),b("Pendidikan Terakhir",r(a.pendidikanTerakhir)),b("Pendidikan Non-Formal",r(a.pendidikanNonFormal)),b("Prestasi / Keahlian Khusus",r(a.prestasi))].join(""),Ee=a=>[A("III. INFORMASI KELUARGA"),b("Data Ayah",r(a.infoAyah)),b("Data Ibu",r(a.infoIbu)),`Anak ke: ${r(a.urutanAnak)}
...
`)},je=a=>{try{if(!a||typeof a!="object")throw new Error("[cvGeneratorService] Data must be a non-null object");const e=we(),t=ye(a.tanggalLahir);return[Ae(e),Se(a,t),Te(a),Ee(a),De(a),Pe(a),Le(a),Ie(a),Ce()].join(`
`)}catch(e){throw console.error("[cvGeneratorService] Error generating CV:",e),e}};function xe(){const a=document.getElementById("view-preview"),e=ca();if(Object.keys(e).length===0){d("Tidak ada data untuk di-preview. Silakan isi formulir terlebih dahulu.","warning"),v("/form");return}const t=Me(e);a.innerHTML=`
    <!-- Preview Header -->
    <div class="mb-4">
      <h2>
    ...
    <!-- Spacing for sticky action bar -->
    <div style="height: 80px;"></div>
  `,Ke()}function ca(){try{const a=sessionStorage.getItem(h.TEMP_DATA);return a?JSON.parse(a):{}}catch(a){return console.error("[PreviewView] Error loading form data:",a),{}}}function Me(a){let e="";const t=i=>i||"-";return e+=`
    <div class="preview-section mb-4">
      <h5 class="text-primary mb-3">
        <i class="bi bi-person"></i> 1. Data Pribadi
      </h5>
      <div class="row g-2">
        <div class="col-md-6"><strong>Nama Lengkap:</strong> ${t(a.namaLengkap)}</div>
        <div class="col-md-6"><strong>Nama Panggilan:</strong> ${t(a.namaPanggilan)}</div>
        <div class="col-md-6"><strong>Tempat Lahir:</strong> ${t(a.tempatLahir)}</div>
        <div class="col-md-6"><strong>Tanggal Lahir:</strong> ${t(a.tanggalLahir)}</div>
        <div class="col-md-6"><strong>Jenis Kelamin:</strong> ${t(a.jenisKelamin)}</div>
        <div class="col-md-6"><strong>Tinggi/Berat:</strong> ${t(a.tinggiBadan)} cm / ${t(a.beratBadan)} kg</div>
        <div class="col-md-6"><strong>Warna Kulit:</strong> ${t(a.warnaKulit)}</div>
        <div class="col-md-6"><strong>Suku:</strong> ${t(a.suku)}</div>
        <div class="col-md-6"><strong>Domisili:</strong> ${t(a.domisili)}</div>
        <div class="col-md-6"><strong>Asal Daerah:</strong> ${t(a.asalDaerah)}</div>
        <div class="col-md-6"><strong>Pekerjaan:</strong> ${t(a.pekerjaan)}</div>
        <div class="col-md-6"><strong>Penghasilan:</strong> ${t(a.penghasilanBulanan)}</div>
        <div class="col-md-6"><strong>Status Rumah:</strong> ${t(a.statusRumah)}</div>
        <div class="col-md-6"><strong>Status Pernikahan:</strong> ${t(a.statusPernikahan)}</div>
        ${a.statusPernikahan==="Duda"||a.statusPernikahan==="Janda"?`<div class="col-md-6"><strong>Jumlah Anak:</strong> ${t(a.jumlahAnak)}</div>`:""}
        <div class="col-md-6"><strong>Pernah Khitbah:</strong> ${t(a.pernahKhitbah)}</div>
        <div class="col-md-6"><strong>Status Izin Menikah:</strong> ${t(a.statusIzin)}</div>
      </div>
    </div>
  `,e+=`
    <div class="preview-section mb-4">
      ...
      <div class="mb-2"><strong>Pendidikan Terakhir:</strong><br>${t(a.pendidikanTerakhir)}</div>
      <div class="mb-2"><strong>Pendidikan Non-Formal:</strong><br>${t(a.pendidikanNonFormal)}</div>
      <div class="mb-2"><strong>Prestasi/Keahlian:</strong><br>${t(a.prestasi)}</div>
    </div>
  `,e+=`
    <div class="preview-section mb-4">
      <h5 class="text-primary mb-3">
      ...
      <div class="mb-2"><strong>Data Ayah:</strong><br>${t(a.infoAyah)}</div>
      <div class="mb-2"><strong>Data Ibu:</strong><br>${t(a.infoIbu)}</div>
      <div class="mb-2"><strong>Urutan Anak:</strong> ${t(a.urutanAnak)}</div>
      <div class="mb-2"><strong>Data Saudara:</strong><br>${t(a.infoSaudara)}</div>
    </div>
  `,e+=`
    <div class="preview-section mb-4">
      <h5 class="text-primary mb-3">
      ...
      <div class="mb-2"><strong>Status Muallaf:</strong> ${t(a.statusMuallaf)}</div>
      <div class="mb-2"><strong>Shalat Wajib:</strong><br>${t(a.shalatWajib)}</div>
      <div class="mb-2"><strong>Ibadah Sunnah:</strong><br>${t(a.ibadahSunnah)}</div>
      <div class="mb-2"><strong>Bacaan Al-Qur'an:</strong><br>${t(a.bacaanQuran)}</div>
      <div class="mb-2"><strong>Kajian Favorit:</strong><br>${t(a.kajianFavorit)}</div>
      <div class="mb-2"><strong>Organisasi Islam:</strong> ${t(a.afiliasiOrganisasi)}</div>
    </div>
  `,e+=`
    <div class="preview-section mb-4">
      <h5 class="text-primary mb-3">
      ...
      <div class="mb-2"><strong>Hobi:</strong> ${t(a.hobi)}</div>
      <div class="mb-2"><strong>Merokok:</strong> ${t(a.merokok)}</div>
      ${a.jenisKelamin==="Laki-laki"?`<div class="mb-2"><strong>Status Jenggot:</strong> ${t(a.statusJenggot)}</div>`:""}
      ${a.jenisKelamin==="Perempuan"?`<div class="mb-2"><strong>Status Hijab:</strong> ${t(a.statusHijab)}</div>`:""}
      <div class="mb-2"><strong>Sifat Positif:</strong><br>${t(a.sifatPositif)}</div>
      <div class="mb-2"><strong>Sifat Negatif:</strong><br>${t(a.sifatNegatif)}</div>
      <div class="mb-2"><strong>Riwayat Penyakit:</strong><br>${t(a.riwayatPenyakit)}</div>
      <div class="mb-2"><strong>Visi Misi Hidup:</strong><br>${t(a.visiMisiHidup)}</div>
    </div>
  `,e+=`
    <div class="preview-section mb-4">
      <h5 class="text-primary mb-3">
      ...
      <div class="mb-2"><strong>Visi & Misi Pernikahan:</strong><br>${t(a.visiPernikahan)}</div>
      <div class="mb-2"><strong>Kriteria Pasangan:</strong><br>${t(a.kriteriaPasangan)}</div>
      <div class="mb-2"><strong>Pandangan Mahar:</strong><br>${t(a.pandanganMahar)}</div>
      ${a.jenisKelamin==="Laki-laki"?`<div class="mb-2"><strong>Pandangan Poligami:</strong> ${t(a.kesediaanPoligami)}</div>`:""}
      ${a.jenisKelamin==="Perempuan"?`<div class="mb-2"><strong>Kesediaan Dipoligami:</strong> ${t(a.kesediaanDipoligami)}</div>`:""}
      <div class="mb-2"><strong>Pandangan Istri Bekerja:</strong> ${t(a.pandanganNafkah)}</div>
      <div class="mb-2"><strong>Kesediaan Pindah:</strong> ${t(a.kesediaanPindah)}</div>
      <div class="mb-2"><strong>Target Menikah:</strong> ${t(a.targetMenikah)}</div>
      <div class="mb-2"><strong>Rencana Setelah Menikah:</strong><br>${t(a.rencanaSetelahMenikah)}</div>
    </div>
  `,e+=`
    <div class="preview-section mb-4">
      <h5 class="text-primary mb-3">
      ...
      <div class="row g-2">
        <div class="col-md-6"><strong>No HP/WhatsApp:</strong> ${t(a.noHP)}</div>
        <div class="col-md-6"><strong>Email:</strong> ${t(a.email)}</div>
        <div class="col-md-6"><strong>Akun Sosmed:</strong> ${t(a.akunSosmed)}</div>
        <div class="col-md-6"><strong>Kontak Wali:</strong> ${t(a.kontakWali)}</div>
      </div>
    </div>
  `,e}function Ke(){const a=document.getElementById("btn-back-to-form"),e=document.getElementById("btn-generate-cv");a&&a.addEventListener("click",()=>{v("/form")}),e&&e.addEventListener("click",Be)}function Be(){const a=ca();if(!a){d("Data tidak ditemukan. Silakan isi formulir terlebih dahulu.","error"),v("/form");return}const e=document.getElementById("btn-generate-cv"),t=e.innerHTML;e.disabled=!0,e.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span>Generating...',setTimeout(()=>{try{const i=je(a);if(!i)throw new Error("Failed to generate CV text");sessionStorage.setItem("taaruf_cv_generated_text",i),sessionStorage.setItem("taaruf_cv_source_data",JSON.stringify(a)),v("/result")}catch(i){console.error("[PreviewView] Error generating CV:",i),d("Gagal men-generate CV. Silakan coba lagi.","error"),e.disabled=!1,e.innerHTML=t}},500)}function He(){xe()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-preview"&&He()});function $e(){const a=document.getElementById("view-result"),e=sessionStorage.getItem(h.GENERATED_TEXT);if(!e){d("Tidak ada CV yang di-generate. Silakan isi formulir terlebih dahulu.","warning"),v("/form");return}const t=e.length.toLocaleString("id-ID");a.innerHTML=`
    <!-- Success Alert -->
    ...
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <span class="badge bg-secondary">${t} karakter</span>
      </div>
      <div class="card-body">
        <textarea 
          id="cv-output" 
    ...
    <!-- Spacing for sticky action bar -->
    <div style="height: 80px;"></div>
  `,Oe()}async function Ne(){const a=document.getElementById("cv-output"),e=document.getElementById("btn-copy-cv");if(a)try{await navigator.clipboard.writeText(a.value),d("CV berhasil disalin ke clipboard!","success");const t=e.innerHTML;e.innerHTML='<i class="bi bi-check"></i> Tersalin!',e.classList.add("btn-success"),e.classList.remove("btn-primary"),setTimeout(()=>{e.innerHTML=t,e.classList.remove("btn-success"),e.classList.add("btn-primary")},2e3)}catch{try{a.select(),document.execCommand("copy"),d("CV berhasil disalin ke clipboard!","success")}catch(i){console.error("[ResultView] All copy methods failed:",i),d("Gagal menyalin. Silakan gunakan Ctrl+A dan Ctrl+C.","error")}}}function Re(){const a=sessionStorage.getItem(h.GENERATED_TEXT),e=sessionStorage.getItem(h.SOURCE_DATA);if(!a||!e){d("Data CV tidak ditemukan. Tidak dapat menyimpan ke history.","error");return}try{const t=JSON.parse(e),i=ee(t,a);if(i.success){d("CV berhasil disimpan ke history!","success");const n=document.getElementById("btn-save-history");n&&(n.disabled=!0,n.innerHTML='<i class="bi bi-check-circle"></i> Sudah Disimpan')}else d(i.message||"Gagal menyimpan ke history","error"),console.error("[ResultView] Save history failed:",i)}catch(t){console.error("[ResultView] Failed to save history:",t),d("Gagal menyimpan ke history. Silakan coba lagi.","error")}}function Ve(){const a=sessionStorage.getItem(h.GENERATED_TEXT);if(!a){d("Tidak ada CV untuk dicetak.","error");return}const e=window.open("","_blank");e.document.write(`
    <!DOCTYPE html>
    <html>
    <head>
  ...
  `),e.document.close(),e.focus(),setTimeout(()=>{e.print()},250)}function _e(){sessionStorage.removeItem(h.TEMP_DATA),sessionStorage.removeItem(h.GENERATED_TEXT),sessionStorage.removeItem(h.SOURCE_DATA),d("Membuat CV baru. Silakan isi formulir.","info"),v("/form")}function Oe(){const a=document.getElementById("btn-copy-cv"),e=document.getElementById("btn-save-history"),t=document.getElementById("btn-print-cv"),i=document.getElementById("btn-new-cv"),n=document.getElementById("btn-back-home");a&&a.addEventListener("click",Ne),e&&e.addEventListener("click",Re),t&&t.addEventListener("click",Ve),i&&i.addEventListener("click",_e),n&&n.addEventListener("click",()=>{v("/")})}function Fe(){$e(),sessionStorage.removeItem(h.TEMP_DATA)}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-result"&&Fe()});function qe(){const a=document.getElementById("view-draft");a.innerHTML=`
    <!-- Page Header -->
    <div class="mb-4">
      <h2>
  ...
  `,ua()}function ua(){const a=document.getElementById("draft-list-container"),t=V().sort((i,n)=>new Date(n.lastUpdated)-new Date(i.lastUpdated));t.length===0?Je(a):We(a,t)}function Je(a){a.innerHTML=`
    <div class="card">
  ...
  `;const e=document.getElementById("btn-create-new");e&&e.addEventListener("click",()=>{v("/form")})}function We(a,e){let t='<div class="list-group">';e.forEach(n=>{t+=`
        ...
        <div class="d-flex w-100 justify-content-between align-items-start">
          <div>
            ...
            <p class="mb-1 text-muted small">
              ...
              Terakhir diupdate: ${N(n.lastUpdated)}
            </p>
    ...
    `}),t+="</div>",a.innerHTML=t,Ye(),[].slice.call(a.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(n=>{new bootstrap.Tooltip(n)})}function Ue(a,e){const t=sa(a);if(!t){d("Draft tidak ditemukan","error");return}e&&C(e,"Memuat..."),setTimeout(()=>{sessionStorage.setItem(h.DRAFT_TO_LOAD,JSON.stringify(t.data)),v("/form"),d("Memuat draft ke formulir...","loading")},300)}function Ge(a){const e=sa(a);if(!e){d("Draft tidak ditemukan","error");return}const t=`Apakah Anda yakin ingin menghapus draft "${e.name}"?

Tindakan ini tidak dapat dibatalkan.`;if(!confirm(t))return;const i=ae(a);i.success?(d("Draft berhasil dihapus","success"),ua()):(d(i.message||"Gagal menghapus draft","error"),console.error("[DraftView] Delete failed:",i))}function Ye(){const a=document.getElementById("draft-list-container");if(!a)return;a.addEventListener("click",t=>{const i=t.target.closest(".btn-load-draft");if(i){const s=i.getAttribute("data-id");Ue(s,i);return}const n=t.target.closest(".btn-delete-draft");if(n){const s=n.getAttribute("data-id");Ge(s);return}}),[].slice.call(a.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(t=>{new bootstrap.Tooltip(t)})}function ze(){qe()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-draft"&&ze()});function Qe(){const a=document.getElementById("view-history");a.innerHTML=`
    <!-- Page Header -->
    <div class="mb-4">
      <h2>
  ...
  `,ma()}function ma(){const a=document.getElementById("history-list-container"),t=_().sort((i,n)=>new Date(n.generatedAt)-new Date(i.generatedAt));t.length===0?Xe(a):Ze(a,t)}function Xe(a){a.innerHTML=`
    <div class="card">
      <div class="card-body empty-state">
  ...
  `;const e=document.getElementById("btn-create-new");e&&e.addEventListener("click",()=>{v("/form")})}function Ze(a,e){let t='<div class="list-group">';e.forEach(n=>{t+=`
...
Sumber: ${s}`,p=T(w);return`
  ...
  `},ha=(a,e)=>{const t=document.getElementById(a);if(!t){console.error(`[DoaHaditsCard] Container #${a} not found`);return}if(!Array.isArray(e)||e.length===0){t.innerHTML=`
      <div class="alert alert-info">
        <i class="bi bi-info-circle"></i>
        Tidak ada konten untuk kategori ini.
      </div>
    `;return}const i=e.map(n=>pa(n)).join("");t.innerHTML=i,va(a)},va=a=>{const e=document.getElementById(a);if(!e)return;e.querySelectorAll(`.${ga}`).forEach(i=>{i.addEventListener("click",async n=>{const s=n.currentTarget,o=s.getAttribute("data-content");s.getAttribute("data-id");const l=s.innerHTML;try{const m=gt(o);await navigator.clipboard.writeText(m),s.innerHTML='<i class="bi bi-check"></i> Tersalin!',s.classList.add("btn-success"),s.classList.remove("btn-outline-primary"),setTimeout(()=>{s.innerHTML=l,s.classList.remove("btn-success"),s.classList.add("btn-outline-primary")},ut)}catch(m){console.error("[DoaHaditsCard] Failed to copy:",m),alert("Gagal menyalin teks. Silakan copy manual.")}})})},T=a=>{const e=document.createElement("div");return e.textContent=a,e.innerHTML},gt=a=>{const e=document.createElement("textarea");return e.innerHTML=a,e.value},pt=Object.freeze(Object.defineProperty({__proto__:null,attachCopyListeners:va,createDoaHaditsCard:pa,renderDoaHaditsCards:ha},Symbol.toStringTag,{value:"Module"}));function ht(){const a=document.getElementById("view-doa");a.innerHTML=`
  ...
  `,vt()}function vt(){["doa-jodoh","doa-khitbah","doa-walimah","hadits-menikah","hadits-pasangan"].forEach(e=>{const t=`cards-${e}`,i=dt(e);ha(t,i)}),ft()}function ft(){document.querySelectorAll('[data-bs-toggle="pill"]').forEach(e=>{e.addEventListener("shown.bs.tab",t=>{const i=t.target.getAttribute("data-bs-target");if(i){const n=document.querySelector(i);if(n){const s=n.querySelector('[id^="cards-"]');s&&ot(()=>Promise.resolve().then(()=>pt),void 0).then(o=>{o.attachCopyListeners(s.id)})}}})})}function kt(){ht()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-doa"&&kt()});function yt(){const a=document.getElementById("view-settings");a.innerHTML=`
    <!-- Page Header -->
    <div class="mb-4">
      <h2>
  ...
  `,wt()}function wt(){const a=document.getElementById("btn-reset-data");a&&a.addEventListener("click",()=>{confirm(`⚠️ PERINGATAN!
...
Apakah Anda BENAR-BENAR YAKIN ingin menghapus semua data?`)&&(C(a,"Menghapus..."),setTimeout(()=>{const i=ie();i.success?(d("Semua data berhasil dihapus. Halaman akan dimuat ulang...","success"),setTimeout(()=>{window.location.reload()},1500)):(S(a),d(i.message||"Gagal menghapus data","error"),console.error("[SettingsView] Clear data failed:",i.error))},500))})}function At(){yt()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-settings"&&At()});window.bootstrap=ya;function Z(){Ea(),Da(),Ca();const a=document.getElementById("year-footer");a&&(a.textContent=new Date().getFullYear()),[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(t){return new wa(t)})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Z):Z();
//# sourceMappingURL=index-C7hiGnGy.js.map
