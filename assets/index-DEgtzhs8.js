import{M as wa,b as Aa,T as Sa}from"./bootstrap-CeGnflBh.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))t(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&t(o)}).observe(document,{childList:!0,subtree:!0});function i(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(n){if(n.ep)return;n.ep=!0;const s=i(n);fetch(n.href,s)}})();const aa={"/":"view-landing","/home":"view-landing","/form":"view-form","/preview":"view-preview","/result":"view-result","/draft":"view-draft","/history":"view-history","/doa":"view-doa","/settings":"view-settings"};function ea(){return window.location.hash.slice(1)||"/"}function Ta(a){document.querySelectorAll(".view-section").forEach(t=>{t.classList.add("d-none")});const i=document.getElementById(a);if(i){i.classList.remove("d-none"),window.scrollTo(0,0);const t=new CustomEvent("viewChanged",{detail:{viewId:a,path:ea()}});window.dispatchEvent(t)}else console.error(`View with ID "${a}" not found`)}function Ea(a){document.querySelectorAll(".navbar-nav .nav-link").forEach(i=>{const t=i.getAttribute("href");i.classList.remove("active"),(t===`#${a}`||a==="/"&&t==="#/")&&i.classList.add("active")})}function O(){const a=ea(),e=aa[a];e?(Ta(e),Ea(a)):(console.warn(`Route "${a}" not found, redirecting to home`),v("/"))}function v(a){window.location.hash=`#${a}`}function Da(){O(),window.addEventListener("hashchange",O),document.addEventListener("click",a=>{const e=a.target.closest('a[href^="#/"]');if(e){a.preventDefault();const i=e.getAttribute("href").slice(1);v(i)}}),console.log("[Router] Initialized with",Object.keys(aa).length,"routes")}let E=null,D=null,P=null;function Pa(){return q(),E=a=>{a.key==="Escape"&&La()},D=a=>{Ia(a.target)},P=()=>{Ca()},document.addEventListener("keydown",E),document.addEventListener("show.bs.modal",D),document.addEventListener("hide.bs.modal",P),q}function q(){E&&(document.removeEventListener("keydown",E),E=null),D&&(document.removeEventListener("show.bs.modal",D),D=null),P&&(document.removeEventListener("hide.bs.modal",P),P=null)}function La(){const a=document.querySelector(".modal.show");if(a){const e=wa.getInstance(a);e&&e.hide()}}const V=new WeakMap;function Ia(a){if(!a)return;if(V.has(a)){const s=V.get(a);a.removeEventListener("keydown",s)}const e=a.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'),i=e[0],t=e[e.length-1];a.dataset.previousFocus=document.activeElement?.id||"",setTimeout(()=>{if(i)try{i.focus()}catch{}},100);const n=s=>{if(s.key==="Tab"){if(s.shiftKey){if(document.activeElement===i){s.preventDefault();try{t.focus()}catch{}}}else if(document.activeElement===t){s.preventDefault();try{i.focus()}catch{}}}};V.set(a,n),a.addEventListener("keydown",n)}function Ca(){const a=document.querySelector(".modal");if(a&&a.dataset.previousFocus){const e=document.getElementById(a.dataset.previousFocus);if(e){const i=e.hasAttribute("disabled"),t=e.offsetParent===null;if(!i&&!t)try{e.focus()}catch{}}}}function xa(){document.addEventListener("keydown",a=>{if((a.ctrlKey||a.metaKey)&&a.key==="s"){a.preventDefault();const e=document.getElementById("btn-save-draft");e&&!e.disabled&&e.click()}if((a.ctrlKey||a.metaKey)&&a.key==="Enter"){const e=document.querySelector('button[type="submit"]');e&&!e.disabled&&e.click()}})}function ja(){const a=document.getElementById("view-landing");a.innerHTML=`
    <!-- Hero Section -->
  ...
  `,Ma()}function Ma(){const a=document.getElementById("btn-start");a&&a.addEventListener("click",()=>{v("/form")}),document.querySelectorAll(".btn-feature").forEach(i=>{i.addEventListener("click",t=>{const n=t.currentTarget.getAttribute("data-route");n&&v(n)})})}function B(){ja()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-landing"&&B()});(window.location.hash===""||window.location.hash==="#/"||window.location.hash==="#/home")&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",B):B());const f={REQUIRED:"Kolom ini wajib diisi.",MIN_LENGTH:a=>`Minimal ${a} karakter.`,MAX_LENGTH:a=>`Maksimal ${a} karakter.`,EMAIL:"Format email tidak valid.",NUMBER:"Harus berupa angka.",MIN_VALUE:a=>`Nilai minimal adalah ${a}.`,MAX_VALUE:a=>`Nilai maksimal adalah ${a}.`,DATE_FUTURE:"Tanggal tidak boleh di masa depan.",PHONE:"Format nomor telepon tidak valid (10-15 digit).",CONDITIONAL:"Kolom ini wajib diisi berdasarkan pilihan sebelumnya.",PATTERN:"Format input tidak sesuai."},Ha={namaLengkap:{required:!0,minLength:3},tempatLahir:{required:!0},tanggalLahir:{required:!0,maxDate:"today"},jenisKelamin:{required:!0},tinggiBadan:{required:!0,min:100,max:250},beratBadan:{required:!0,min:30,max:200},pekerjaan:{required:!0},statusPernikahan:{required:!0},jumlahAnak:{conditional:!0,min:0,max:20},domisili:{required:!0},statusIzin:{required:!0},pendidikanTerakhir:{required:!0,minLength:10},infoAyah:{required:!0,minLength:10},infoIbu:{required:!0,minLength:10},urutanAnak:{required:!0,pattern:/^\d+\s+dari\s+\d+$/},shalatWajib:{required:!0},bacaanQuran:{required:!0},sifatPositif:{required:!0},sifatNegatif:{required:!0},merokok:{required:!0},statusHijab:{conditional:!0},statusJenggot:{conditional:!0},visiPernikahan:{required:!0,minLength:20},kriteriaPasangan:{required:!0,minLength:20},kesediaanPoligami:{conditional:!0},kesediaanDipoligami:{conditional:!0},noHP:{pattern:/^[0-9]{10,15}$/},email:{type:"email"}},Ka=a=>{const e=a.querySelectorAll("input, select, textarea");return Array.from(e).filter(i=>!i.closest(".d-none"))},ia=a=>a.nextElementSibling?.classList.contains("invalid-feedback")?a.nextElementSibling:null,Va=(a,e)=>a.hasAttribute("required")&&!e?(y(a,f.REQUIRED),!1):!0,Ba=(a,e,i)=>i?.minLength&&e.length<i.minLength?(y(a,f.MIN_LENGTH(i.minLength)),!1):i?.maxLength&&e.length>i.maxLength?(y(a,f.MAX_LENGTH(i.maxLength)),!1):!0,$a=(a,e,i)=>{if(a.type!=="number")return!0;const t=parseFloat(e);return i?.min!==void 0&&t<i.min?(y(a,f.MIN_VALUE(i.min)),!1):i?.max!==void 0&&t>i.max?(y(a,f.MAX_VALUE(i.max)),!1):!0},Ra=(a,e,i)=>{if(a.type!=="date"||i?.maxDate!=="today")return!0;const t=new Date(e),n=new Date;return n.setHours(0,0,0,0),t>n?(y(a,f.DATE_FUTURE),!1):!0},Na=(a,e,i,t)=>{if(!i?.pattern||!e)return!0;if(!i.pattern.test(e)){const n=t==="noHP"?f.PHONE:f.PATTERN;return y(a,n),!1}return!0},_a=(a,e,i)=>i?.type!=="email"||!e||/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)?!0:(y(a,f.EMAIL),!1),J=(a,e=!1)=>{try{const i=a.hasAttribute("required"),t=a.value.trim()!=="";if(e&&!(a.classList.contains("is-invalid")||a.classList.contains("is-valid")))return;if(L(a),!i&&!t){L(a);return}if(a.checkValidity())na(a);else{const s=ia(a)?.textContent||f.REQUIRED;y(a,s)}}catch(i){console.error("[ValidationService] Error in validateFieldOnEvent:",i)}};function ta(a){try{if(!a)return console.error("[ValidationService] Field is null or undefined"),!1;const e=a.name||a.id,i=a.value.trim(),t=Ha[e];return L(a),a.closest(".d-none")?!0:Va(a,i)?!i&&!a.hasAttribute("required")?!0:!Ba(a,i,t)||!$a(a,i,t)||!Ra(a,i,t)||!Na(a,i,t,e)||!_a(a,i,t)?!1:a.checkValidity()?(na(a),!0):(y(a,a.validationMessage||f.REQUIRED),!1):!1}catch(e){return console.error("[ValidationService] Error in validateField:",e),!1}}function Fa(a){try{if(!a)return console.error("[ValidationService] Form element is null or undefined"),{isValid:!1,firstInvalidField:null};const i=Ka(a).filter(t=>!ta(t));return{isValid:i.length===0,firstInvalidField:i[0]||null}}catch(e){return console.error("[ValidationService] Error in validateForm:",e),{isValid:!1,firstInvalidField:null}}}function y(a,e){a.classList.remove("is-valid"),a.classList.add("is-invalid");const i=ia(a);i&&(i.textContent=e)}function na(a){a.classList.remove("is-invalid"),a.classList.add("is-valid")}function L(a){a.classList.remove("is-invalid","is-valid")}function Oa(a){try{if(!a){console.error("[ValidationService] Form element is null or undefined");return}const e=a.querySelectorAll("input, select, textarea");e.forEach(i=>{i.addEventListener("blur",()=>{J(i,!1)}),i.addEventListener("input",()=>{J(i,!0)})}),console.log("[ValidationService] Real-time validation initialized for",e.length,"fields")}catch(e){console.error("[ValidationService] Error initializing real-time validation:",e)}}const qa=36,Ja=2,Wa=6;function Ua(){if(typeof crypto<"u"&&crypto.randomUUID)return crypto.randomUUID();if(typeof crypto<"u"&&crypto.getRandomValues){const a=new Uint8Array(16);crypto.getRandomValues(a),a[6]=a[6]&15|64,a[8]=a[8]&63|128;const e=Array.from(a,i=>i.toString(16).padStart(2,"0")).join("");return`${e.slice(0,8)}-${e.slice(8,12)}-${e.slice(12,16)}-${e.slice(16,20)}-${e.slice(20)}`}throw new Error("Crypto API not available. Cannot generate secure UUID.")}function Ga(a="id"){const e=Date.now(),i=Math.random().toString(qa).substring(Ja,Wa);return`${a}_${e}_${i}`}function Ya(){return Ga("draft")}function za(){return`cv_${Ua()}`}function M(){return new Date().toISOString()}function Qa(a){if(!a)return null;const e=new Date(a);if(isNaN(e.getTime()))return null;const i=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agt","Sep","Okt","Nov","Des"],t=String(e.getDate()).padStart(2,"0"),n=i[e.getMonth()],s=e.getFullYear();return`${t} ${n} ${s}`}function $(a){if(!a)return null;const e=new Date(a);if(isNaN(e.getTime()))return null;const i=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agt","Sep","Okt","Nov","Des"],t=String(e.getDate()).padStart(2,"0"),n=i[e.getMonth()],s=e.getFullYear(),o=String(e.getHours()).padStart(2,"0"),l=String(e.getMinutes()).padStart(2,"0");return`${t} ${n} ${s}, ${o}:${l}`}function sa(a,e=!1){return e?$(a):Qa(a)}const k={DRAFTS:"taaruf_cv_drafts",HISTORY:"taaruf_cv_history",SETTINGS:"taaruf_cv_settings"};M();function R(){try{const a="__storage_test__";return localStorage.setItem(a,a),localStorage.removeItem(a),!0}catch(a){return console.error("localStorage is not available:",a),!1}}function I(a,e){try{if(!R())return{success:!1,message:"localStorage tidak tersedia. Pastikan browser Anda tidak dalam mode privat.",error:new Error("Storage not available")};const i=JSON.stringify(e);return localStorage.setItem(a,i),{success:!0,message:"Data berhasil disimpan"}}catch(i){return i.name==="QuotaExceededError"?{success:!1,message:"Penyimpanan penuh. Hapus draft/history lama untuk melanjutkan.",error:i}:{success:!1,message:`Gagal menyimpan data: ${i.message}`,error:i}}}function H(a){try{if(!R())return{success:!1,data:null,message:"localStorage tidak tersedia",error:new Error("Storage not available")};const e=localStorage.getItem(a);return e===null?{success:!0,data:null,message:"Data tidak ditemukan"}:{success:!0,data:JSON.parse(e),message:"Data berhasil dimuat"}}catch(e){return console.error(`Error loading data from ${a}:`,e),{success:!1,data:null,message:"Data corrupt atau format tidak valid. Pertimbangkan untuk reset data.",error:e}}}const Xa=(a,e=null)=>{const i=Ya(),t=M(),n=e||`Draft - ${a.namaLengkap||"Tanpa Nama"} - ${sa(t)}`;return{id:i,name:n,createdAt:t,lastUpdated:t,data:a}},Za=(a,e,i,t)=>{const n=M();return a.map(s=>s.id===e?{...s,lastUpdated:n,data:i,...t&&{name:t}}:s)};function ae(a,e=null,i=null){try{const n=H(k.DRAFTS).data||[];if(i){if(!n.some(b=>b.id===i))return{success:!1,message:"Draft tidak ditemukan"};const o=Za(n,i,a,e),l=I(k.DRAFTS,o);return l.success?{...l,data:{id:i}}:l}else{const s=Xa(a,e),o=[...n,s],l=I(k.DRAFTS,o);return l.success?{...l,data:{id:s.id}}:l}}catch(t){return{success:!1,message:`Error saving draft: ${t.message}`,error:t}}}function N(){const a=H(k.DRAFTS);return a.success?a.data||[]:(console.error("Error loading drafts:",a.message),[])}function ra(a){return N().find(i=>i.id===a)||null}function ee(a){try{const e=N();if(!e.some(n=>n.id===a))return{success:!1,message:"Draft tidak ditemukan"};const t=e.filter(n=>n.id!==a);return I(k.DRAFTS,t)}catch(e){return{success:!1,message:`Error deleting draft: ${e.message}`,error:e}}}function ie(a,e,i=null){try{const n=H(k.HISTORY).data||[],s=za(),o=M(),l=i||`${a.namaLengkap} - ${sa(o)}`,b={id:s,name:l,generatedAt:o,cvTextContent:e,sourceData:a},u=[...n,b],g=I(k.HISTORY,u);return g.success?{...g,data:{id:s}}:g}catch(t){return{success:!1,message:`Error saving history: ${t.message}`,error:t}}}function _(){const a=H(k.HISTORY);return a.success?a.data||[]:(console.error("Error loading history:",a.message),[])}function F(a){return _().find(i=>i.id===a)||null}function te(a){try{const e=_();if(!e.some(n=>n.id===a))return{success:!1,message:"History tidak ditemukan"};const t=e.filter(n=>n.id!==a);return I(k.HISTORY,t)}catch(e){return{success:!1,message:`Error deleting history: ${e.message}`,error:e}}}function ne(){try{return R()?(Object.values(k).forEach(a=>{localStorage.removeItem(a)}),{success:!0,message:"Semua data berhasil dihapus"}):{success:!1,message:"localStorage tidak tersedia"}}catch(a){return{success:!1,message:`Error clearing data: ${a.message}`,error:a}}}const se="toast-container",re="toast",oe="toast",le="toast-header",de="toast-body",ce=2,ue=9,W="Notifikasi",U="info",G=5e3,Y={success:{icon:"bi bi-check-circle-fill text-success",headerClass:"bg-success bg-opacity-10"},error:{icon:"bi bi-exclamation-circle-fill text-danger",headerClass:"bg-danger bg-opacity-10"},warning:{icon:"bi bi-exclamation-triangle-fill text-warning",headerClass:"bg-warning bg-opacity-10"},info:{icon:"bi bi-info-circle-fill text-primary",headerClass:"bg-primary bg-opacity-10"},loading:{icon:"spinner-border spinner-border-sm text-white",headerClass:"bg-danger text-white"}},d=(a,e)=>{let i;if(typeof a=="string")i={title:W,message:a,type:e||U,duration:G};else if(typeof a=="object"&&a!==null)i={title:a.title||W,message:a.message||"",type:a.type||U,duration:a.duration!==void 0?a.duration:G,onClose:a.onClose};else{console.error("[ToastNotification] Invalid options parameter");return}const{title:t,message:n,type:s,duration:o,onClose:l}=i,b=`${re}-${Date.now()}-${Math.random().toString(36).substr(ce,ue)}`,u=document.getElementById(se);if(!u){console.error("[ToastNotification] Toast container not found");return}const g=me(s),w=`
    <div id="${b}" class="${oe}" role="alert" aria-live="assertive" aria-atomic="true">
      <div class="${le} ${g.headerClass}">
        <i class="${g.icon} me-2"></i>
        <strong class="me-auto">${t}</strong>
        <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
      </div>
      ${n?`<div class="${de}">${n}</div>`:""}
    </div>
  `;u.insertAdjacentHTML("beforeend",w);const p=document.getElementById(b);if(!p){console.error("[ToastNotification] Failed to create toast element");return}const K=new bootstrap.Toast(p,{autohide:o>0,delay:o});p.addEventListener("hidden.bs.toast",()=>{p.remove(),typeof l=="function"&&l()}),K.show(),console.log(`[ToastNotification] Showed ${s} toast: ${t}`)},me=a=>Y[a]||Y.info,be="spinner-border-sm",x="originalContent",j="originalDisabled";function C(a,e="Memproses..."){a&&(a.dataset[x]=a.innerHTML,a.dataset[j]=a.disabled,a.disabled=!0,a.innerHTML=`
    <span class="spinner-border ${be} me-2" role="status" aria-hidden="true"></span>
    ${e}
  `)}function S(a){a&&(a.dataset[x]&&(a.innerHTML=a.dataset[x],delete a.dataset[x]),a.dataset[j]!==void 0?(a.disabled=a.dataset[j]==="true",delete a.dataset[j]):a.disabled=!1)}const h={TEMP_DATA:"taaruf_cv_temp_data",DRAFT_TO_LOAD:"taaruf_cv_draft_to_load",GENERATED_TEXT:"taaruf_cv_generated_text",SOURCE_DATA:"taaruf_cv_source_data"};function ge(){const a=document.getElementById("view-form");a.innerHTML=`
    <!-- Form Header -->
    <div class="mb-4">
      <h2>
  ...
  `;const e=new Date().toISOString().split("T")[0],i=document.getElementById("tanggalLahir");i&&i.setAttribute("max",e),pe()}function pe(){const a=document.getElementById("cv-form"),e=document.getElementById("btn-reset-form"),i=document.getElementById("btn-save-draft"),t=document.getElementById("jenisKelamin"),n=document.getElementById("statusPernikahan");t&&t.addEventListener("change",oa),n&&n.addEventListener("change",la),he(a),a&&a.addEventListener("submit",s=>{s.preventDefault(),fe()}),e&&e.addEventListener("click",()=>{ke()}),i&&i.addEventListener("click",()=>{ve()})}function oa(a){const e=a.target.value,i=document.getElementById("wrapper-statusJenggot"),t=document.getElementById("wrapper-kesediaanPoligami"),n=document.getElementById("statusJenggot"),s=document.getElementById("kesediaanPoligami"),o=document.getElementById("wrapper-statusHijab"),l=document.getElementById("wrapper-kesediaanDipoligami"),b=document.getElementById("statusHijab"),u=document.getElementById("kesediaanDipoligami");e==="Laki-laki"?(i.classList.remove("d-none"),t.classList.remove("d-none"),n.setAttribute("required","required"),s.setAttribute("required","required"),o.classList.add("d-none"),l.classList.add("d-none"),b.removeAttribute("required"),u.removeAttribute("required"),b.value="",u.value=""):e==="Perempuan"?(o.classList.remove("d-none"),l.classList.remove("d-none"),b.setAttribute("required","required"),u.setAttribute("required","required"),i.classList.add("d-none"),t.classList.add("d-none"),n.removeAttribute("required"),s.removeAttribute("required"),n.value="",s.value=""):(i.classList.add("d-none"),t.classList.add("d-none"),o.classList.add("d-none"),l.classList.add("d-none"),n.removeAttribute("required"),s.removeAttribute("required"),b.removeAttribute("required"),u.removeAttribute("required"))}function la(a){const e=a.target.value,i=document.getElementById("wrapper-jumlahAnak"),t=document.getElementById("jumlahAnak");e==="Duda"||e==="Janda"?(i.classList.remove("d-none"),t.setAttribute("required","required")):(i.classList.add("d-none"),t.removeAttribute("required"),t.value="")}function he(a){a.querySelectorAll("input, select, textarea").forEach(i=>{i.addEventListener("blur",()=>{ta(i)}),i.addEventListener("input",()=>{i.classList.contains("is-invalid")&&L(i)})})}function da(){const a=document.getElementById("cv-form"),e={};return a.querySelectorAll("input, select, textarea").forEach(t=>{const n=t.name||t.id,s=t.value.trim();t.closest(".d-none")||!n||(e[n]=s)}),e}function ve(){const a=document.getElementById("btn-save-draft"),e=da();if(!Object.values(e).some(t=>t!=="")){d("Tidak ada data untuk disimpan","warning");return}C(a,"Menyimpan..."),setTimeout(()=>{const t=ae(e);S(a),t.success?(d("Draft berhasil disimpan! Anda dapat melanjutkan nanti.","success"),console.log("[FormView] Draft saved with ID:",t.data?.id)):(d(t.message||"Gagal menyimpan draft","error"),console.error("[FormView] Save draft failed:",t))},500)}function z(a){const e=document.getElementById("cv-form");!e||!a||(Object.keys(a).forEach(i=>{const t=e.querySelector(`[name="${i}"], #${i}`);t&&a[i]&&(t.value=a[i],(i==="jenisKelamin"||i==="statusPernikahan")&&t.dispatchEvent(new Event("change")))}),console.log("[FormView] Draft loaded successfully"),d("Draft berhasil dimuat","success"))}function fe(){const a=document.getElementById("cv-form"),e=Fa(a);if(!e.isValid){d("Form belum lengkap. Periksa field yang ditandai merah.","error"),e.firstInvalidField&&(e.firstInvalidField.scrollIntoView({behavior:"smooth",block:"center"}),e.firstInvalidField.focus());return}const i=da();try{sessionStorage.setItem(h.TEMP_DATA,JSON.stringify(i)),console.log("[FormView] Form data saved to sessionStorage"),v("/preview")}catch(t){console.error("[FormView] Error saving to sessionStorage:",t),d("Gagal menyimpan data. Silakan coba lagi.","error")}}function ke(){if(confirm("Apakah Anda yakin ingin mereset semua isian form?")){const a=document.getElementById("cv-form");a.reset(),oa({target:{value:""}}),la({target:{value:"Lajang"}}),a.querySelectorAll("input, select, textarea").forEach(i=>L(i)),console.log("[FormView] Form reset"),d("Form berhasil direset","info")}}function ye(){ge();const a=document.getElementById("cv-form");a&&Oa(a);const e=sessionStorage.getItem(h.DRAFT_TO_LOAD);if(e)try{const t=JSON.parse(e);setTimeout(()=>{z(t),sessionStorage.removeItem(h.DRAFT_TO_LOAD),console.log("[FormView] Draft loaded from Draft page")},100),console.log("[FormView] Form view initialized with draft data");return}catch(t){console.error("[FormView] Error loading draft:",t),d("Gagal memuat draft","error")}const i=sessionStorage.getItem(h.TEMP_DATA);if(i)try{const t=JSON.parse(i);setTimeout(()=>{z(t),sessionStorage.removeItem(h.TEMP_DATA),console.log("[FormView] Restored data from preview (temp data cleared)")},100),console.log("[FormView] Form view initialized with preview data");return}catch(t){console.error("[FormView] Error loading temp data:",t),d("Gagal memuat data dari preview","error")}console.log("[FormView] Form view initialized with real-time validation")}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-form"&&ye()});const ca=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"],we=a=>{if(!a||a==="")return"-";try{const e=a.split("-");if(e.length!==3)return"-";const[i,t,n]=e,s=parseInt(i,10),o=parseInt(t,10),l=parseInt(n,10);return isNaN(s)||isNaN(o)||isNaN(l)||o<1||o>12||l<1||l>31?"-":`${l} ${ca[o-1]} ${s}`}catch(e){return console.error("[cvGeneratorService] Error formatting date:",e),"-"}},r=a=>a==null||a===""?"-":String(a).trim(),Ae=()=>{const a=new Date,e=a.getDate(),i=ca[a.getMonth()],t=a.getFullYear();return`${e} ${i} ${t}`},A=a=>`${a}
${"-".repeat(64)}
`,c=(a,e)=>`${a.padEnd(20)}: ${e}
`,m=(a,e)=>`${a}:
${e}

`,Se=a=>{const e="=".repeat(64);return[e,"                    CURRICULUM VITAE TA'ARUF",e,`Tanggal Pembuatan: ${a}`,""].join(`
`)},Te=(a,e)=>{const i=[A("I. DATA PRIBADI"),c("Nama Lengkap",r(a.namaLengkap)),c("Nama Panggilan",r(a.namaPanggilan)),c("Tempat, Tgl Lahir",`${r(a.tempatLahir)}, ${e}`),c("Jenis Kelamin",r(a.jenisKelamin)),c("Tinggi / Berat",`${r(a.tinggiBadan)} cm / ${r(a.beratBadan)} kg`),c("Warna Kulit",r(a.warnaKulit)),c("Suku Bangsa",r(a.suku)),c("Domisili Saat Ini",r(a.domisili)),c("Asal Daerah",r(a.asalDaerah)),c("Pekerjaan",r(a.pekerjaan)),c("Pengalaman Kerja",r(a.pengalamanKerja)),c("Penghasilan Bulanan",r(a.penghasilanBulanan)),c("Status Tempat Tinggal",r(a.statusRumah)),c("Status Pernikahan",r(a.statusPernikahan))];return(a.statusPernikahan==="Duda"||a.statusPernikahan==="Janda")&&i.push(c("Jumlah Anak",r(a.jumlahAnak))),i.push(c("Pernah Khitbah",r(a.pernahKhitbah)),c("Status Izin Wali",r(a.statusIzin)),`
`),i.join("")},Ee=a=>[A("II. RIWAYAT PENDIDIKAN"),m("Pendidikan Terakhir",r(a.pendidikanTerakhir)),m("Pendidikan Non-Formal",r(a.pendidikanNonFormal)),m("Prestasi / Keahlian Khusus",r(a.prestasi))].join(""),De=a=>[A("III. INFORMASI KELUARGA"),m("Data Ayah",r(a.infoAyah)),m("Data Ibu",r(a.infoIbu)),`Anak ke: ${r(a.urutanAnak)}

`,m("Data Saudara",r(a.infoSaudara))].join(""),Pe=a=>[A("IV. IBADAH & PEMAHAMAN AGAMA"),c("Status Muallaf",r(a.statusMuallaf)),`
`,m("Pelaksanaan Shalat Wajib",r(a.shalatWajib)),m("Kebiasaan Ibadah Sunnah",r(a.ibadahSunnah)),m("Kemampuan Baca Al-Qur'an & Hafalan",r(a.bacaanQuran)),m("Kajian / Ustadz Favorit",r(a.kajianFavorit)),m("Organisasi / Komunitas Islam",r(a.afiliasiOrganisasi))].join(""),Le=a=>{const e=[A("V. PROFIL DIRI & KEBIASAAN"),c("Hobi / Kegemaran",r(a.hobi)),c("Merokok",r(a.merokok))];return a.jenisKelamin==="Laki-laki"&&e.push(c("Status Jenggot",r(a.statusJenggot))),a.jenisKelamin==="Perempuan"&&e.push(c("Status Hijab",r(a.statusHijab))),e.push(`
`,m("Sifat Positif (Kelebihan)",r(a.sifatPositif)),m("Sifat Negatif (Kekurangan)",r(a.sifatNegatif)),m("Riwayat Penyakit",r(a.riwayatPenyakit)),m("Visi Misi Hidup",r(a.visiMisiHidup))),e.join("")},Ie=a=>{const e=[A("VI. VISI PERNIKAHAN"),m("Visi & Misi Pernikahan",r(a.visiPernikahan)),m("Kriteria Calon Pasangan",r(a.kriteriaPasangan)),m("Pandangan tentang Mahar",r(a.pandanganMahar))];return a.jenisKelamin==="Laki-laki"&&e.push(c("Pandangan tentang Poligami",r(a.kesediaanPoligami))),a.jenisKelamin==="Perempuan"&&e.push(c("Kesediaan Dipoligami",r(a.kesediaanDipoligami))),e.push(c("Pandangan Istri Bekerja",r(a.pandanganNafkah)),c("Kesediaan Pindah Domisili",r(a.kesediaanPindah)),c("Target Waktu Menikah",r(a.targetMenikah)),`
`,m("Rencana Setelah Menikah",r(a.rencanaSetelahMenikah))),e.join("")},Ce=a=>[A("VII. KONTAK (Untuk Keperluan Mediator)"),c("No HP/WhatsApp",r(a.noHP)),c("Email",r(a.email)),c("Akun Sosmed",r(a.akunSosmed)),c("Kontak Wali",r(a.kontakWali)),`
`].join(""),xe=()=>{const a="=".repeat(64);return[a,"*Data ini diisi dengan sebenar-benarnya dan dapat","dipertanggungjawabkan.*",a].join(`
`)},je=a=>{try{if(!a||typeof a!="object")throw new Error("[cvGeneratorService] Data must be a non-null object");const e=Ae(),i=we(a.tanggalLahir);return[Se(e),Te(a,i),Ee(a),De(a),Pe(a),Le(a),Ie(a),Ce(a),xe()].join(`
`)}catch(e){throw console.error("[cvGeneratorService] Error generating CV:",e),e}};function Me(){const a=document.getElementById("view-preview"),e=ua();if(Object.keys(e).length===0){d("Tidak ada data untuk di-preview. Silakan isi formulir terlebih dahulu.","warning"),v("/form");return}const i=He(e);a.innerHTML=`
    <!-- Preview Header -->
    <div class="mb-4">
      <h2>
    ...
    <!-- Spacing for sticky action bar -->
    <div style="height: 80px;"></div>
  `,Ke()}function ua(){try{const a=sessionStorage.getItem(h.TEMP_DATA);return a?JSON.parse(a):{}}catch(a){return console.error("[PreviewView] Error loading form data:",a),{}}}function He(a){let e="";const i=t=>t||"-";return e+=`
  ...
  `,e}function Ke(){const a=document.getElementById("btn-back-to-form"),e=document.getElementById("btn-generate-cv");a&&a.addEventListener("click",()=>{v("/form")}),e&&e.addEventListener("click",Ve)}function Ve(){const a=ua();if(!a){d("Data tidak ditemukan. Silakan isi formulir terlebih dahulu.","error"),v("/form");return}const e=document.getElementById("btn-generate-cv"),i=e.innerHTML;e.disabled=!0,e.innerHTML='<span class="spinner-border spinner-border-sm me-2"></span>Generating...',setTimeout(()=>{try{const t=je(a);if(!t)throw new Error("Failed to generate CV text");sessionStorage.setItem("taaruf_cv_generated_text",t),sessionStorage.setItem("taaruf_cv_source_data",JSON.stringify(a)),console.log("[PreviewView] CV generated successfully"),v("/result")}catch(t){console.error("[PreviewView] Error generating CV:",t),d("Gagal men-generate CV. Silakan coba lagi.","error"),e.disabled=!1,e.innerHTML=i}},500)}function Be(){Me()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-preview"&&Be()});function $e(){const a=document.getElementById("view-result"),e=sessionStorage.getItem(h.GENERATED_TEXT);if(!e){d("Tidak ada CV yang di-generate. Silakan isi formulir terlebih dahulu.","warning"),v("/form");return}const i=e.length.toLocaleString("id-ID");a.innerHTML=`
    <!-- Success Alert -->
  ...
  `),e.document.close(),e.focus(),setTimeout(()=>{e.print()},250),console.log("[ResultView] Print dialog opened")}function Fe(){sessionStorage.removeItem(h.TEMP_DATA),sessionStorage.removeItem(h.GENERATED_TEXT),sessionStorage.removeItem(h.SOURCE_DATA),d("Membuat CV baru. Silakan isi formulir.","info"),v("/form"),console.log("[ResultView] Starting new CV, sessionStorage cleared")}function Oe(){const a=document.getElementById("btn-copy-cv"),e=document.getElementById("btn-save-history"),i=document.getElementById("btn-print-cv"),t=document.getElementById("btn-new-cv"),n=document.getElementById("btn-back-home");a&&a.addEventListener("click",Re),e&&e.addEventListener("click",Ne),i&&i.addEventListener("click",_e),t&&t.addEventListener("click",Fe),n&&n.addEventListener("click",()=>{v("/")})}function qe(){$e(),sessionStorage.removeItem(h.TEMP_DATA),console.log("[ResultView] Cleared temporary form data")}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-result"&&qe()});function Je(){const a=document.getElementById("view-draft");a.innerHTML=`
    <!-- Page Header -->
    <div class="mb-4">
      <h2>
  ...
  `,ma()}function ma(){const a=document.getElementById("draft-list-container"),i=N().sort((t,n)=>new Date(n.lastUpdated)-new Date(t.lastUpdated));i.length===0?We(a):Ue(a,i),console.log(`[DraftView] Loaded ${i.length} drafts`)}function We(a){a.innerHTML=`
    <div class="card">
  ...
  `;const e=document.getElementById("btn-create-new");e&&e.addEventListener("click",()=>{v("/form")})}function Ue(a,e){let i='<div class="list-group">';e.forEach(n=>{i+=`
    ...
    `}),i+="</div>",a.innerHTML=i,ze(),[].slice.call(a.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(n=>{new bootstrap.Tooltip(n)})}function Ge(a,e){const i=ra(a);if(!i){d("Draft tidak ditemukan","error");return}e&&C(e,"Memuat..."),setTimeout(()=>{sessionStorage.setItem(h.DRAFT_TO_LOAD,JSON.stringify(i.data)),v("/form"),console.log("[DraftView] Loading draft:",a),d("Memuat draft ke formulir...","loading")},300)}function Ye(a){const e=ra(a);if(!e){d("Draft tidak ditemukan","error");return}const i=`Apakah Anda yakin ingin menghapus draft "${e.name}"?

Tindakan ini tidak dapat dibatalkan.`;if(!confirm(i))return;const t=ee(a);t.success?(d("Draft berhasil dihapus","success"),console.log("[DraftView] Deleted draft:",a),ma()):(d(t.message||"Gagal menghapus draft","error"),console.error("[DraftView] Delete failed:",t))}function ze(){const a=document.getElementById("draft-list-container");if(!a)return;a.addEventListener("click",i=>{const t=i.target.closest(".btn-load-draft");if(t){const s=t.getAttribute("data-id");Ge(s,t);return}const n=i.target.closest(".btn-delete-draft");if(n){const s=n.getAttribute("data-id");Ye(s);return}}),[].slice.call(a.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(i=>{new bootstrap.Tooltip(i)})}function Qe(){Je()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-draft"&&Qe()});function Xe(){const a=document.getElementById("view-history");a.innerHTML=`
    <!-- Page Header -->
    <div class="mb-4">
      <h2>
  ...
  `,ba()}function ba(){const a=document.getElementById("history-list-container"),i=_().sort((t,n)=>new Date(n.generatedAt)-new Date(t.generatedAt));i.length===0?Ze(a):ai(a,i),console.log(`[HistoryView] Loaded ${i.length} history items`)}function Ze(a){a.innerHTML=`
    <div class="card">
      <div class="card-body empty-state">
  ...
  `;const e=document.getElementById("btn-create-new");e&&e.addEventListener("click",()=>{v("/form")})}function ai(a,e){let i='<div class="list-group">';e.forEach(n=>{i+=`
...
Sumber: ${s}`,p=T(w);return`
    <div class="card ${ci}" ${X}="${e}" ${mi}="${o}">
      ...
      <div class="card-footer">
        <button 
          class="btn btn-outline-primary btn-sm ${ha}" 
          ${bi}="${p}"
          ${X}="${e}"
        >
          <i class="bi bi-clipboard"></i> Copy
  ...
  `},fa=(a,e)=>{const i=document.getElementById(a);if(!i){console.error(`[DoaHaditsCard] Container #${a} not found`);return}if(!Array.isArray(e)||e.length===0){i.innerHTML=`
      <div class="alert alert-info">
        <i class="bi bi-info-circle"></i>
        Tidak ada konten untuk kategori ini.
      </div>
    `;return}const t=e.map(n=>va(n)).join("");i.innerHTML=t,ka(a)},ka=a=>{const e=document.getElementById(a);if(!e)return;e.querySelectorAll(`.${ha}`).forEach(t=>{t.addEventListener("click",async n=>{const s=n.currentTarget,o=s.getAttribute("data-content"),l=s.getAttribute("data-id"),b=s.innerHTML;try{const u=gi(o);await navigator.clipboard.writeText(u),s.innerHTML='<i class="bi bi-check"></i> Tersalin!',s.classList.add("btn-success"),s.classList.remove("btn-outline-primary"),setTimeout(()=>{s.innerHTML=b,s.classList.remove("btn-success"),s.classList.add("btn-outline-primary")},ui),console.log(`[DoaHaditsCard] Content copied for ID: ${l}`)}catch(u){console.error("[DoaHaditsCard] Failed to copy:",u),alert("Gagal menyalin teks. Silakan copy manual.")}})})},T=a=>{const e=document.createElement("div");return e.textContent=a,e.innerHTML},gi=a=>{const e=document.createElement("textarea");return e.innerHTML=a,e.value},pi=Object.freeze(Object.defineProperty({__proto__:null,attachCopyListeners:ka,createDoaHaditsCard:va,renderDoaHaditsCards:fa},Symbol.toStringTag,{value:"Module"}));function hi(){const a=document.getElementById("view-doa");a.innerHTML=`
  ...
  `,vi()}function vi(){["doa-jodoh","doa-khitbah","doa-walimah","hadits-menikah","hadits-pasangan"].forEach(e=>{const i=`cards-${e}`,t=di(e);fa(i,t)}),console.log("[DoaView] Loaded",pa.length,"doa/hadits items"),fi()}function fi(){document.querySelectorAll('[data-bs-toggle="pill"]').forEach(e=>{e.addEventListener("shown.bs.tab",i=>{const t=i.target.getAttribute("data-bs-target");if(t){const n=document.querySelector(t);if(n){const s=n.querySelector('[id^="cards-"]');s&&li(()=>Promise.resolve().then(()=>pi),void 0).then(o=>{o.attachCopyListeners(s.id)})}}})})}function ki(){hi()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-doa"&&ki()});function yi(){const a=document.getElementById("view-settings");a.innerHTML=`
    <!-- Page Header -->
    <div class="mb-4">
      <h2>
...
Apakah Anda BENAR-BENAR YAKIN ingin menghapus semua data?`)&&(console.log("[SettingsView] Clearing all data..."),C(a,"Menghapus..."),setTimeout(()=>{const t=ne();t.success?(d("Semua data berhasil dihapus. Halaman akan dimuat ulang...","success"),setTimeout(()=>{window.location.reload()},1500)):(S(a),d(t.message||"Gagal menghapus data","error"),console.error("[SettingsView] Clear data failed:",t.error))},500))})}function Ai(){yi()}window.addEventListener("viewChanged",a=>{a.detail.viewId==="view-settings"&&Ai()});window.bootstrap=Aa;function Z(){console.log("[App] Initializing Taaruf CV Kreator..."),Da(),Pa(),xa();const a=document.getElementById("year-footer");a&&(a.textContent=new Date().getFullYear()),[].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(i){return new Sa(i)}),console.log("[App] Router initialized successfully"),console.log("[App] Keyboard navigation & accessibility enabled"),console.log("[App] Phase 5.4: UI/UX Polish & Refinements - COMPLETED")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Z):Z();
//# sourceMappingURL=index-DEgtzhs8.js.map
